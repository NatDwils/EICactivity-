...
public class Player {
	...
	public static String highestCount(List<Player>playerList) {
			 ...
			 for(Player player:playerList) {
				 if(playerByNationalityCount.containsKey(player.getNationality())) {
					 playerByNationalityCount.put(player.getNationality(),playerByNationalityCount.get(player.getNationality())+1);
				 }
				 else {
					 playerByNationalityCount.put(player.getNationality(),1);
				 }
			 }
				 
				 String maxNationality = "";
				 int maxcount = 0;
				 for(Map.Entry<String, Integer> entry:playerByNationalityCount.entrySet()) {
