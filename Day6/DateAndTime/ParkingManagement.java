...
public static void main(String[] args) {
        ...
        if (entryTime.isAfter(currentTime)) {
            ...
            Duration duration = Duration.between(entryTime, currentTime);long hours = duration.toHours();
            int cost = (int) (hours * 15);System.out.println("The parking cost is: Rs." + cost);
            }
            }